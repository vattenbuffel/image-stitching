...
img_path = '/Users/hadleybai/Downloads/design_project/F_result'
img1 = cv2.imread(img_path + '/stitch_43_p.png')
# img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2GRAY)
img2 = cv2.imread(img_path + '/stitch_21_p.png')
...
# result = cv2.addWeighted(img1, 0.5, result, 0.5, gamma=0.0)
# result[0:img1.shape[0], 0:img1.shape[1]] = img1
...
cv2.imwrite('F_result/stitch_42.png', img_overlay)
# cv2.imwrite('F_result/stitch_4321_p.png', result)
print('finish')
